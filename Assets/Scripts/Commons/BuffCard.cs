...
public static class BuffCard
{
    ...
    private class Meta { public string Name; public string Code; public string Image; public string Effect; }

    private static readonly Dictionary<BuffCardType, Meta> META = new Dictionary<BuffCardType, Meta>
    {
        { BuffCardType.SoftDrink,  new Meta{ Name="ソフトドリンク",   Code="soft",   Image="Cards/Soft Drink",  Effect="1D8・2D6・2D8 の成功確率＋5" } },
        { BuffCardType.Beer,       new Meta{ Name="ビール",           Code="beer",   Image="Cards/Beer",        Effect="1D10を振り、出目ぶん全ダイスの成功確率＋" } },
        { BuffCardType.OtherDrink, new Meta{ Name="アザードリンク",   Code="other",  Image="Cards/Other Drink", Effect="1D6を振り、出目ぶん全ダイスの成功確率＋／攻撃力＋1" } },
        { BuffCardType.SideDish,   new Meta{ Name="サイドディッシュ", Code="side",   Image="Cards/Side Dish",   Effect="全ダイスの成功確率＋5" } },
        { BuffCardType.StapleFood, new Meta{ Name="メインフード",     Code="main",   Image="Cards/Staple Food", Effect="1D100に成功したとき攻撃力＋1" } },
        { BuffCardType.Sweets,     new Meta{ Name="スイーツ",         Code="sweets", Image="Cards/Sweets",      Effect="自分を含む全員の成功確率＋5" } },
        { BuffCardType.SP1,        new Meta{ Name="スペシャルカード1", Code="sp1",    Image="Cards/SP1",         Effect="1D10を振り、出目ぶん全ダイスの成功確率＋／攻撃力＋1" } },
        { BuffCardType.SP2,        new Meta{ Name="スペシャルカード2", Code="sp2",    Image="Cards/SP2",         Effect="1D10を振り、出目ぶん全ダイスの成功確率＋／攻撃力＋1" } },
    };
